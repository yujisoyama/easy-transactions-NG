        ...
        <div className="w-full my-4 text-background">
            <div className="flex flex-row justify-between gap-5 items-center">
                <div className="flex flex-row gap-4 historyResponsive:flex-col mobile:text-[12px]">
                    <input onChange={props.selectDate} className="w-[140px] text-center border-2 border-background outline-none bg-main rounded-md focus:border-highlightGreen mobile:w-[100px]" type="date" name="date" id="date" max={maxDate} />
